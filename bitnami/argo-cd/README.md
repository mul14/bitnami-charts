...
| `config.tls.certificates`                      | TLS certificates used to verify the authenticity of the repository servers. Ref: https://argo-cd.readthedocs.io/en/stable/operator-manual/declarative-setup/#repositories-using-self-signed-tls-certificates-or-are-signed-by-custom-ca | `{}`   |
